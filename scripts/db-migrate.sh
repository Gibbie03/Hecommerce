...
for name in 0002_auth_shim.sql 0003_icommerce_schema.sql 0004_view_counter.sql 0005_business_created_by.sql 0006_fix_recursive_helpers.sql 0007_fix_claim_policy_recursion.sql 0008_fix_membership_returning.sql; do
